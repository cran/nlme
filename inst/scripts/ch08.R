...
fm2CO2.nlme <- nlme( fm1CO2.lis, random = Asym + lrc ~ 1 )
fm2CO2.nlme
...
#  start = c(-4.255, 5.622, 1.258, -0.09555, 0.10434), method = "REML")
#fm1Wafer.nlmeR
...
fm1Ovar.nlme
ACF( fm1Ovar.nlme )
# plot( ACF(fm1Ovar.nlme,  maxLag = 10),
#        alpha = 0.05 )
